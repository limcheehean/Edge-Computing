...
RECORD_SECONDS = 200         # Specify the time to record from the microphone in seconds
...
# design the filter
sos = design_filter(2000, 10000, 48000, 3) #change the lower and higher freqcies according to choice
